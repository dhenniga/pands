...
//    private static final String URL_MAIN = "https://www.primpandstyle.com/wc-api/v3/products?consumer_key=ck_962b3c0e86f61ebef52ddb90f5721dcc5d2c5fc8&consumer_secret=cs_fe0ba2a0f443603553f9e30b0112644d03ff22ac";
    ...
    private static final String URL_FILTER_LIMIT = "filter[limit]=90";
    ...
    private static final String QUERY = URL_BASE + URL_MAIN_1 + "?" + URL_BASE_FIELDS + "&" + URL_FILTER_LAST_CHANCE_TO_BUY + "&" + URL_FILTER_LIMIT + "&" +URL_CONSUMER_KEY + "&" + URL_CONSUMER_SECRET;
